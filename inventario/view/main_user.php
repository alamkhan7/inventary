	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        <div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
	                ...
	                <div class="collapse" id="menu4">
	                    <a href="view_user/register_categoria.php" class="list-group-item" data-parent="#menu4"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_user/view_categoria.php" class="list-group-item" data-parent="#menu4"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu5">
	                    <a href="view_user/register_producto.php" class="list-group-item" data-parent="#menu5"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_user/view_producto.php" class="list-group-item" data-parent="#menu5"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu6">
	                    <a href="view_user/register_inventario.php" class="list-group-item" data-parent="#menu6"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_user/view_inventario.php" class="list-group-item" data-parent="#menu6"><i class="fa fa-eye"></i>Visualizar</a>
	                    <a href="view_user/report.php" class="list-group-item" data-parent="#menu6"><i class="fa fa-file-pdf-o"></i>Reporte</a>
	                </div>    
	            </div>
	        </div>
