	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        <div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
	                ...
	                <div class="collapse" id="menu1">
	                    <a href="view_admin/register_school.php" class="list-group-item" data-parent="#menu1"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_school.php" class="list-group-item" data-parent="#menu1"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu2">
	                    <a href="view_admin/register_area.php" class="list-group-item" data-parent="#menu2"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_area.php" class="list-group-item" data-parent="#menu2"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu3">
	                    <a href="view_admin/register_responsable.php" class="list-group-item" data-parent="#menu3"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_responsable.php" class="list-group-item" data-parent="#menu3"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu4">
	                    <a href="view_admin/register_categoria.php" class="list-group-item" data-parent="#menu4"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_categoria.php" class="list-group-item" data-parent="#menu4"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu5">
	                    <a href="view_admin/register_producto.php" class="list-group-item" data-parent="#menu5"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_producto.php" class="list-group-item" data-parent="#menu5"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>
	                ...
	                <div class="collapse" id="menu6">
	                    <a href="view_admin/register_inventario.php" class="list-group-item" data-parent="#menu6"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_inventario.php" class="list-group-item" data-parent="#menu6"><i class="fa fa-eye"></i>Visualizar</a>
	                    <a href="view_admin/report.php" class="list-group-item" data-parent="#menu6"><i class="fa fa-file-pdf-o"></i>Reporte</a>
	                </div>
	                ...
	                <div class="collapse" id="menu7">
	                    <a href="view_admin/register_usuario.php" class="list-group-item" data-parent="#menu7"><i class="fa fa-pencil-square-o"></i>Registrar</a>
	                    <a href="view_admin/view_usuario.php" class="list-group-item" data-parent="#menu7"><i class="fa fa-eye"></i>Visualizar</a>
	                </div>     
	            </div>
	        </div>
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container">
	            	<p><i class="fa fa-newspaper-o"></i> BIENVENIDO AL SISTEMA DE INVENTARIADO V 1.0</p>
	            </div>
	        </main>
	    </div>
	</div>
