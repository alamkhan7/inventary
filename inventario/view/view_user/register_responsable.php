...
<?php 
	...
	if(isset($_POST['registrar_responsable'])){
		...
		if($responsable->registrar($nombre,$cargo,$dni,$telefono,$area)){
	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        ...
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container" style="padding: 20px;">
	              <h1 class="display-5">Responsable. Registrar</h1>
		          <form method="POST">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="cargo" placeholder="Cargo..." required="required" autocomplete="off" maxlength="255">
					  </div>
					  <div class="form-row">
						<div class="form-group col-lg-6">
						    <label for="dni">Dni:</label>
						    <input type="text" class="form-control" name="dni" placeholder="Dni..." required="required" autocomplete="off" maxlength="8">
					  	</div>
					  	<div class="form-group col-lg-6">
						    <label for="telefono">Teléfono:</label>
						    <input type="text" class="form-control" name="telefono" placeholder="Télefono..." autocomplete="off" maxlength="255">
					  	</div>
					  </div>
					  ...
					  <div class="form-group">
					  	...
					  	<?php  
					  		...
					  		$responsable->view_area($query);

					  	?>
					  </select>
					  </div>
					<div class="form-group">
					    <button type="submit" class="btn btn-primary" name="registrar_responsable">Registrar</button>
					</div>
				</form>
	            </div>
	        </main>
