...
<?php 
	...
	if(isset($_POST['registrar_usuario'])){
		...
		if($user->registrar_user($usuario,$contrasena,$estado,$privilegio,$responsable)){
	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        ...
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container" style="padding: 20px;">
	              <h1 class="display-5">Usuario. Registrar</h1>
		          <form method="POST">
					  <div class="form-group">
					    <label for="usuario">Usuario:</label>
					    <input type="text" class="form-control" name="usuario" placeholder="Usuario..." required="required" autocomplete="off" maxlength="255">
					  </div>
					  <div class="form-group">
					    <label for="contrasena">Contraseña:</label>
					    <input type="password" class="form-control" name="contrasena" placeholder="Contraseña..." required="required" autocomplete="off" maxlength="255">
					  </div>
					  ...
					  <div class="form-group">
					  	...
					  	<select class="form-control" name="responsable" required="required">
					  	<?php  

					  		$query = "SELECT * FROM responsable";
					  		$user->view_responsable($query);
