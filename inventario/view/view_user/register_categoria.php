...
?>
<?php include('../../controller/categoria.php'); 
...
<?php 
	...
	if(isset($_POST['registrar_categoria'])){
		...
		if($categoria->registrar($nombre,$descripcion)){
	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        ...
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container" style="padding: 20px;">
	              <h1 class="display-5">Categoria. Registrar</h1>
		          <form method="POST">
					...
					<div class="form-group">
					    <button type="submit" class="btn btn-primary" name="registrar_categoria">Registrar</button>
					</div>
				</form>
	            </div>
	        </main>
