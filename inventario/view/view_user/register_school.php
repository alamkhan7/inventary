...
?>
<?php include('../../controller/colegio.php'); 
...
<?php 
	...
	if(isset($_POST['registrar_colegio'])){
		...
		if($colegio->registrar($tipo,$nombre,$direccion,$ciudad)){
	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        ...
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container" style="padding: 20px;">
	              <h1 class="display-5">Colegio. Registrar</h1>
		          <form method="POST">
					  <div class="form-group">
					    ...
					    <small id="emailHelp" class="form-text text-muted">Especificar el nombre de la I.E.</small>
					  </div>
					  <div class="form-group">
					    <label for="direccion">Direccion:</label>
					    <input type="text" class="form-control" name="direccion" placeholder="Direccion..." autocomplete="off" maxlength="255">
					  </div>
					  <div class="form-group">
					    <label for="lugar">Ciudad:</label>
					    <input type="text" class="form-control" name="ciudad" placeholder="Ciudad..." required="required" autocomplete="off" maxlength="255">
					  </div>
					 ...
					 <div class="form-check form-check-inline">
					  <label class="form-check-label">
					    <input class="form-check-input" type="radio" name="tipo"  value="PB"> Pública
					  </label>
					</div>
					<div class="form-check form-check-inline">
					  <label class="form-check-label">
					    <input class="form-check-input" type="radio" name="tipo"  value="PV"> Privada
					  </label>
					</div>
					<div class="form-group">
					    <button type="submit" class="btn btn-primary" name="registrar_colegio">Registrar</button>
					</div>
				</form>
	            </div>
	        </main>
