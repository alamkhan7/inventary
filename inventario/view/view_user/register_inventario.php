...
?>
<?php include('../../controller/inventario.php'); 
...
<?php 
	...
	if(isset($_POST['registrar_inventario'])){
		...
		if($inventario->registrar($n_inventario,$fecha,$responsable,$producto)){
	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        ...
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container" style="padding: 20px;">
	              <h1 class="display-5">Inventario. Registrar</h1>
		          <form method="POST">
					  <div class="form-group">
					    <label for="n_inventario">N° Inventario:</label>
					    <input type="text" class="form-control" name="n_inventario" placeholder="N° Inventario..." required="required" autocomplete="off" maxlength="255">
					    <small id="emailHelp" class="form-text text-muted">Especificar el número de Inventario.</small>
					  </div>
					  <div class="form-row">
						  	...
						  	<select class="form-control" name="responsable">
								<?php  
									...
									$nombre = $_SESSION['nombre'];
							  		...
							  		$inventario->view_responsable($query);
						  ...
						  <div class="form-group col-lg-6">
						  	...
						  	<select class="form-control" name="producto">
						  		<?php  
							  		...
							  		$inventario->view_producto($query);
					...
					<div class="form-group">
					    <button type="submit" class="btn btn-primary" name="registrar_inventario">Registrar</button>
					</div>
				</form>
	            </div>
	        </main>
