...
?>
<?php include('../../controller/producto.php'); 
...
<?php 
	...
	if(isset($_POST['registrar_producto'])){
		...
		if($producto->registrar($nombre,$caracteristicas,$cantidad,$estado,$uso,$categoria)){
	    ...
	    <div class="row d-flex d-md-block flex-nowrap wrapper">
	        ...
	        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
	            <div class="container" style="padding: 20px;">
	              <h1 class="display-5">Producto. Registrar</h1>
		          <form method="POST">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="caracteristicas" placeholder="Características..." autocomplete="off" maxlength="255">
					  </div>
					  <div class="form-row">
						  <div class="form-group col-lg-6">
						    <label for="direccion">Cantidad:</label>
						    <input type="text" class="form-control" name="cantidad" placeholder="Cantidad..." autocomplete="off" maxlength="255">
						  </div>
						  <div class="form-group col-lg-6">
					...
					<div class="form-group">
					    <button type="submit" class="btn btn-primary" name="registrar_producto">Registrar</button>
					</div>
				</form>
	            </div>
	        </main>
